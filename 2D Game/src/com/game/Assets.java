...
public class Assets 
{
	...
	public static Sprite titleButton = new Sprite(new SpriteSheet(ImageLoader.loadImage("/textures/TitleButton.png/")).getAnimation(1, 0, 160, 160), "StartButton", 160, 160);
	public static Sprite startButton = new Sprite(new SpriteSheet(ImageLoader.loadImage("/textures/StartButton.png/")).getAnimation(1, 0, 32, 18), "StartButton", 32, 18);
