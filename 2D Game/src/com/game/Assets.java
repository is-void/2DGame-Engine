...
public class Assets
{
	...
	public static Sprite[] grasspathTiles_1 = new Sprite[16];

	public static Sprite[] watergrassTiles_1 = new Sprite[20];
	public static Sprite air;

	public static Sprite title, optionsButton;

	public static Sprite titleButton = new Sprite();
	public static Sprite startButton = new Sprite();
	public static HashMap<Integer, Tile> tileID = new HashMap<>();
	...
	public static void initializeAssets(Game game) throws CloneNotSupportedException
	{
		...
		playerSprites = new SpriteSheet(ImageLoader.loadImage(Game.HierarichalFile("/res/textures/testplayer_idle.png")));
		player_move = new Sprite(playerSprites.getAnimation(1, 0, 30, 51), "upAnim", 30, 51);

		tiles = new SpriteSheet(ImageLoader.loadImage(Game.HierarichalFile("/res/textures/Tiles.png")));
		...
		tileSprites = new SpriteSheet(ImageLoader.loadImage(Game.HierarichalFile("/res/textures/Test Block.png")));
